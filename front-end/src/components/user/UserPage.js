...
import { ButtonGroup, Dropdown, DropdownButton, Table,Card } from 'react-bootstrap';
     ...
     this.setState({ selectedOption });
      ...
      if(selectedOption == 1){
       ...
       this.setState({
        ...
        axios.post('http://ec2-54-212-242-149.us-west-2.compute.amazonaws.com:8080/click/view',postUser).then(response => response.data)
        .then((data) => {
          console.log(data)
    ...
    render() {
      ...
      <React.Fragment>
        ...
        <ButtonGroup>
          ...
          &nbsp;&nbsp;
          <Button variant="primary" onClick={this.userUpload}>Upload Image Page</Button>{' '}
          &nbsp;&nbsp;
          <Button variant="primary" onClick={this.userUpdate}>Update Image Page</Button>{' '}
          &nbsp;&nbsp;
          <Button variant="primary" onClick={this.userDelete}>Delete Image Page</Button>{' '}
          &nbsp;&nbsp;
          <Button variant="primary" onClick={this.userDownload}>Download Image Page</Button>{' '}
        </ButtonGroup>
        </div>
